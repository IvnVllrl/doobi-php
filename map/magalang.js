...
const map = new maptilersdk.Map({
  ...
  center: [120.65939, 15.21454], // starting position [lng, lat]
...
const magalangTerminal = new maptilersdk.Marker({
  color: "black", // Marker Color
  symbol: "marker", // Marker Icon (custom image URL)
})
  .setLngLat([120.65939, 15.21454])
  .addTo(map);
...
map.on("load", async function () {
  map.addSource("gps_tracks", {
    type: "geojson",
    data: "Marquee_-_Magalang.geojson",
  });
